  ...
  public class PostAggregate : AggregateRoot
  {
    ...
    public void AddComment(string comment, string username)
    {
      ...
      if (string.IsNullOrEmpty(username))
        throw new InvalidOperationException($"The value of {nameof(username)} cannot be null or empty");
    ...
    public void EditComment(Guid commentId, string comment, string username)
    {
      ...
      if (!_comments[commentId].Item2.Equals(username, StringComparison.CurrentCultureIgnoreCase))
        throw new InvalidOperationException("You are not allowed to edit a comment that was mabe by another user");
    ...
    public void DeletePost(string username)
    {
      ...
      if (!_author.Equals(username, StringComparison.CurrentCultureIgnoreCase))
        throw new InvalidOperationException("You are not allowed to delete that was made by someonse else");
