...
namespace _1_TaskProgramming
{
  static class Program
  {
    ...
    static void Main(string[] _)
    {
      ...
      Task t1 = new(Write, "Hello");
      t1.Start();

      //Taks method with generics
      const string text1 = "testing", text2 = "this";
      ...
      //Exception handling
      var erro1 = Task.Factory.StartNew(() => throw new InvalidOperationException() { Source = "t" });

      var erro2 = Task.Factory.StartNew(() => throw new AccessViolationException() { Source = "t2" });
