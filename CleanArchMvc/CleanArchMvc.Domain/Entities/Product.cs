...
namespace CleanArchMvc.Domain.Entities
{
  public class Product : Entity
  {
    ...
    private void ValidateDomain(string name, string description, decimal price, int stock, string image)
    {
      ...
      DomainExceptionValidation.When(string.IsNullOrEmpty(image), "Invalid image. Name is required.");
      DomainExceptionValidation.When(image?.Length < 3, "Invalid image, too short, minimum 3 characters.");
